...
@Echo=Product.create(name:"Echo Show 5",picture:"https://static.bhphoto.com/images/images2000x2000/1559831958_1484013.jpg",price:34,description:"Connect with video calling and messaging – Call friends and family who have the Alexa app, an Echo device with a screen, or Skype. Make announcements to other devices in your home.")
@Blink=Product.create(name:"Blink Mini" ,picture:"https://press.aboutamazon.com/system/files-encrypted/nasdaq_kms/inline-images/Blink%20Mini%20Indoor%20Thumbnail_0.jpg",price:65,description:"1080P HD indoor, plug-in security camera with motion detection and two way audio that lets you monitor the inside of your home day and night.")
